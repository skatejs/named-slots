(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', 'debounce', './util/each', './version'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('debounce'), require('./util/each'), require('./version'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.debounce, global.each, global.version);
    global.index = mod.exports;
  }
})(this, function (module, exports, _debounce, _each, _version) {
  'use strict';
