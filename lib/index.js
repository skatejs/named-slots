(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', './util/each', './util/can-patch-native-accessors', 'debounce', './util/get-escaped-text-content', './util/get-comment-node-outer-html', './version', './util/weak-map'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('./util/each'), require('./util/can-patch-native-accessors'), require('debounce'), require('./util/get-escaped-text-content'), require('./util/get-comment-node-outer-html'), require('./version'), require('./util/weak-map'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.each, global.canPatchNativeAccessors, global.debounce, global.getEscapedTextContent, global.getCommentNodeOuterHtml, global.version, global.weakMap);
    global.index = mod.exports;
  }
})(this, function (module, exports, _each, _canPatchNativeAccessors, _debounce, _getEscapedTextContent, _getCommentNodeOuterHtml, _version, _weakMap) {
  'use strict';
