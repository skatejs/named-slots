(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', './util/each', './util/can-patch-native-accessors', 'debounce', './util/get-escaped-text-content', './version', './util/weak-map'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('./util/each'), require('./util/can-patch-native-accessors'), require('debounce'), require('./util/get-escaped-text-content'), require('./version'), require('./util/weak-map'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.each, global.canPatchNativeAccessors, global.debounce, global.getEscapedTextContent, global.version, global.weakMap);
    global.index = mod.exports;
  }
})(this, function (module, exports, _each, _canPatchNativeAccessors, _debounce, _getEscapedTextContent, _version, _weakMap) {
  'use strict';
  ...
  var members = {
    ...
    innerHTML: {
      get: function get() {
        var innerHTML = '';
        (0, _each.eachChildNode)(this, function (node) {
          innerHTML += node.nodeType === 1 ? node.outerHTML : (0, _getEscapedTextContent2.default)(node);
        });
        return innerHTML;
      },
