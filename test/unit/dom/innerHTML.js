  ...
  function runTests(type) {
    describe(`${type}: `, () => {
      ...
      it('should return correct value if html was appended', () => {
        ...
        if (type !== 'host') {
          canPatchNativeAccessors && expect(elem.__innerHTML).to.equal('<div></div><div2></div2>');
        } else {
        ...
        if (type !== 'host') {
          canPatchNativeAccessors && expect(elem.__innerHTML).to.equal('<div><div3></div3></div><div2></div2>');
        } else {
          expect(slot.assignedNodes().length).to.equal(2);
        }
        ...
        if (type !== 'host') {
          canPatchNativeAccessors && expect(elem.__innerHTML).to.equal('<div><div3></div3><div4></div4></div><div2></div2>');
        } else {
          expect(slot.assignedNodes().length).to.equal(2);
        }
      });
      ...
      it('should return correct value if html was removed', () => {
        ...
        if (type !== 'host') {
          canPatchNativeAccessors && expect(elem.__innerHTML).to.equal('<div2><div3></div3><div4></div4></div2><div3></div3>');
        } else {
          expect(slot.assignedNodes().length).to.equal(2);
        }
        ...
        if (type !== 'host') {
          canPatchNativeAccessors && expect(elem.__innerHTML).to.equal('<div3></div3>');
        } else {
          expect(slot.assignedNodes().length).to.equal(1);
        }
      ...
      it('should return correct value if html was inserted', () => {
        ...
        if (type !== 'host') {
          canPatchNativeAccessors && expect(elem.__innerHTML).to.equal('<div></div><div1></div1><div2><div3></div3><div4></div4></div2><div3></div3>');
        } else {
        ...
        if (type !== 'host') {
          canPatchNativeAccessors && expect(elem.__innerHTML).to.equal('<div></div><div1></div1><div2><div3></div3><div4></div4></div2><div5></div5><div3></div3>');
        } else {
      ...
      it('should return correct value if html was replaced', () => {
        ...
        if (type !== 'host') {
          canPatchNativeAccessors && expect(elem.__innerHTML).to.equal('<div></div><div2><div3></div3><div4></div4></div2><div3></div3>');
        }
        ...
        if (type !== 'host') {
          canPatchNativeAccessors && expect(elem.__innerHTML).to.equal('<div></div><div2><div3></div3><div4></div4></div2><div5></div5>');
        } else {
