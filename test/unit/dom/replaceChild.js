  ...
  function runTests (type) {
    describe(`${type}: `, () => {
      ...
      it('should return the replaced element node', () => {
        ...
        expect(htmlContent(elem)).to.be.equal('<test1></test1>');
      });
      ...
      it('should replace an element node with an element node', () => {
        ...
        expect(replaced).to.be.equal(node);
        expect(replaced.parentNode).to.be.equal(null);
        expect(htmlContent(elem)).to.be.equal('<newnode></newnode>');
      ...
      it('should replace an element node with a text node', () => {
        ...
        expect(replaced).to.be.equal(node);
        expect(replaced.parentNode).to.be.equal(null);
        expect(htmlContent(elem)).to.be.equal('newnode');
      ...
      it('should replace a node in a parent with two or more children', () => {
        ...
        htmlContent(elem, '<div1></div1><div2><div3><div4><div5></div5></div4><div6></div6></div3><div7></div7></div2><div8></div8><div9></div9>'); // eslint-disable-line max-len
        ...
        expect(replaced.parentNode).to.be.equal(null);
        expect(htmlContent(elem)).to.be.equal('<div1></div1><div2><div3><div4><div5></div5></div4><div6></div6></div3><div7></div7></div2><newnode></newnode><div9></div9>'); // eslint-disable-line max-len
      ...
      it('should replace a node with children', () => {
        ...
        expect(htmlContent(elem)).to.be.equal('<div1></div1><newnode></newnode><div8></div8><div9></div9>'); // eslint-disable-line max-len
      ...
      it('should replace a node with children with another node with children', () => {
        ...
        expect(replaced.parentNode).to.be.equal(null);
        expect(replaced.innerHTML).to.be.equal('<div3><div4><div5></div5></div4><div6></div6></div3><div7></div7>'); // eslint-disable-line max-len
        expect(htmlContent(elem)).to.be.equal('<div1></div1><newnode><newdiv1></newdiv1><newdiv2><newdiv4></newdiv4></newdiv2><newdiv3></newdiv3></newnode><div8></div8><div9></div9>'); // eslint-disable-line max-len
      ...
      it('should be able to replace in sequence', () => {
        ...
        expect(htmlContent(elem)).to.be.equal('<newnode></newnode><div2><div3><div4><div5></div5></div4><div6></div6></div3><div7></div7></div2><div8></div8><div9></div9>'); // eslint-disable-line max-len
        if (type === 'host') {
          expect(slot.assignedNodes().length).to.equal(4);
        }
        elem.removeChild(elem.firstChild);
        elem.replaceChild(node, elem.firstChild);
        expect(htmlContent(elem)).to.be.equal('<newnode></newnode><div8></div8><div9></div9>');
        if (type === 'host') {
          expect(slot.assignedNodes().length).to.equal(3);
        }
        elem.removeChild(elem.firstChild);
        elem.replaceChild(node, elem.firstChild);
        expect(htmlContent(elem)).to.be.equal('<newnode></newnode><div9></div9>');
        if (type === 'host') {
